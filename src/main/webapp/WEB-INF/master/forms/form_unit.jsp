            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        ...
                        <legend class="card-title text-center">SubDivision</legend>
                        <form:form action="/master/add_unit" method="POST" name="unit"  class="was-validated">

                            <input class="form-control" type="hidden" name="id" value="${unit.id}" required>
                            ...
                            <center>
                                <c:if test="${unit.id==null}">
                                    <input type="submit" id="in"  class="btn btn_add" name="add_unit" value="Create">
                                </c:if>
                                <c:if test="${unit.id!=null}">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center text-justify">
                                ...
                                <span class="ml-2" style="font-size:16pt;">the SubDivision is already exists</span>
                            </div>
