            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        ...
                        <form:form action="/master/add_unit_to_diveCenter" method="POST" name="diveCenter"  class="was-validated">

                            <input type="hidden" name="id_unit" class="form-control" value="${unit.id}">

                            <c:if test="${!empty diveCenterList}">

                                <div class="row mb-3">
                                    <label class="col-sm-6 col-form-label ln">Відділення:</label>
                                    <div class="col-sm-12">
                                            <select name="diveCenter_id" class="form-select">
                                                <c:forEach var="diveCenter" items="${diveCenterList}" varStatus="i">
                                                    <option value="${diveCenter.id}">${diveCenter.name} </option>
                                                </c:forEach>
                                            </select>
                                    </div>
                                </div>
                            ...
                            <c:if test="${empty diveCenterList}">
                                <h3><center>no SubDivision</center></h3>
                            </c:if>
