            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        ...
                        <legend class="card-title text-center">Specialization</legend>


                        <form:form action="/master/add_specialization" method="POST" name="specialization"  class="was-validated">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center text-justify">
                                ...
                                <span class="ml-2" style="font-size:16pt;">The specialization already exists</span>
                            </div>
