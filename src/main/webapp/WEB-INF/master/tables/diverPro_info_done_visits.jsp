    ...
    <div class="row">
        ...
        <content class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <ul class="nav nav-tabs ">
                <li class="nav-item">
                    <a href="/master/${diverPro.id}/diverPro_info" class="nav-link link-custom " tabindex="-1" aria-disabled="true">
                        Appointments
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link link-custom active" href="/master/${diverPro.id}/diverPro_info/done" aria-current="page" >
                        Conducted visits
                    </a>
                </li>
            ...
            <div class="col-xl-5 col-lg-5 col-md-7 col-sm-5 pt-1 px-2 pb-2 mx-auto">
                <form class="d-flex" id="search" method="GET" action="/master/${diverPro.id}/diverPro_info/done">
                    ...
                    <a href="/master/${diverPro.id}/diverPro_info/done" class="btn btn_find_all">Current</a>
                </form>
            </div>
