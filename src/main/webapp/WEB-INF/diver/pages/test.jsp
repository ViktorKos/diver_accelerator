        ...
        <content>
            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form">
                    ...
                    <div id="return">
                        <button onclick="document.location = '/patient/doneTests';" type="button" class="btn btn-circle btn-lg d-flex justify-content-center align-items-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form" name="test">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-6 col-form-label ln">Type of test:</label>
                                <div class="col-sm-6">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" placeholder="diverPro" value="${test.result}" readonly>
                                </div>
                            </div>
