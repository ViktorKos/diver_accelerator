...
<c:url value="/instructor/add_user" var="addUrl"/>
<body>
<div class="container">
        ...
        <content>
            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                ...
                <div class="card card_form">
                    ...
                    <div class="card-body">
                        <legend class="card-title text-center">Account</legend>
                        <form:form action="${addUrl}" method="POST" name="user"  class="was-validated">
                            ...
                            <center>
                                ...
                                <input type="submit" id="in" class="btn btn_form_add" name="${add_user}" value="Create">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center text-justify">
                                ...
                                <span class="ml-2" style="font-size:16pt;">Login is already exists</span>
                            </div>
