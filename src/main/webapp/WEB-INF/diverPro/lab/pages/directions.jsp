    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 p-0">
            ...
            <div style="background-color: #ffffff;">
                <content>
                    <h2 class="text-center mt-3">Diver appointment list: ${diver.surname} ${diver.name.charAt(0)}.${diver.middle_name.charAt(0)}.</h2>
                    ...
                    <div class="row row-cols-1 row-cols-md-4 g-4 mx-2 mt-1 mb-3">
                        ...
                        <c:forEach var="directions" items="${directionsList}" varStatus="i">
                            <div class="col" onclick='document.location="<c:url value='/lab/${diver.id}/test/${directions.number}'/>"'>
