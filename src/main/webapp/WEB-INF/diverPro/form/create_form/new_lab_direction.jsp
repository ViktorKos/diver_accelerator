        ...
        <content>
            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                ...
                <div class="card card_form">
                    ...
                    <div id="return">
                        <button onclick="document.location = '/diverPro/${id_visit}/choose_action_lab_direction/';" type="button" class="btn btn-circle btn-lg d-flex justify-content-center align-items-center">
                    ...
                    <div class="card-body">
                        <legend class="card-title text-center">Direction to local recreation</legend>
                        <form:form  method="POST" modelAttribute="direction" action="/add_lab_direction">
                            ...
                            <center>
                                <input type="submit" id="in" name="${add_lab_direction}" class="btn btn_form_add" value="Next">
                            </center>
                            <p>${message}</p>
