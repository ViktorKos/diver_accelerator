                ...
                <div class="card card_form">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form" name="visit">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-6 col-form-label ln">Test:</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" placeholder="immersion" value="${visit.immersion.max_deep}" readonly>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label class="col-sm-6 col-form-label ln">DiverPro specialization:</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" placeholder="diverPro" value="${visit.diverPro.specialization.name}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" placeholder="base" value="${visit.equipment}" maxlength="100" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" type="text" placeholder="none" value="${visit.notes}" maxlength="100" readonly>
                                </div>
                            </div>
