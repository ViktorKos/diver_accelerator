                ...
                <content>
                    ...
                    <div class="table-wrapper-scroll-y my-custom-scrollbar">
                        ...
                        <table class="table tableFixHead">
                            <thead>
                            <tr>
                                <th>Date<a href="/${id_visit}/visits/1" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                                <th>Result<a href="/${id_visit}/visits/2" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                                <th>DiverPro<a href="/${id_visit}/visits/3" class="btn btn-sm "><i class="bi bi-sort-down"></i></a></th>
                    ...
                    <c:if test="${visitsList.isEmpty()}">
                        <h2 class="pt-5"><em><center>no Visits</center></em></h2>
                    </c:if>
