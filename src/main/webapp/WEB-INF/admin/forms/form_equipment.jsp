            ...
            <div class="col-xl-7 col-lg-10 col-md-10 col-sm-10 mx-auto p-3 pt-3">
                <div class="card card_form shadow">
                    <div class="card-body ">
                        ...
                        <form:form action="/admin/add_equipmentCatalog" method="POST" name="equipment"  class="was-validated">


                            <div class="row mb-3">
                                <label class="col-sm-6 col-form-label ln">Id:</label>
                                <div class="col-sm-6">
                                    <input class="form-control " type="text" name="id" value="${equipment.id}" required>
                                </div>
                            </div>
                            ...
                            <center>
                                <c:if test="${empty equipment.id}">
                                    <input type="submit" id="in"  class="btn btn_add" name="add_equipment" value="Create">
                                </c:if>
                                <c:if test="${!empty equipment.id}">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center text-justify">
                                ...
                                <span class="ml-2" style="font-size:16pt;">Таке спорядження вже існує</span>
                            </div>
